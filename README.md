# JSweet processing-webcam candy

## Description

This project is a Java bridge to the processing-webcam library, so that processing-webcam can be used from Java (thanks to the JSweet transpiler).
...
<dependency>
	...
	<artifactId>processing-webcam</artifactId>
